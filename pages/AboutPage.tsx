        ...
        <div className="relative z-20 max-w-7xl mx-auto px-6 lg:px-8 w-full">
          <div className="max-w-2xl reveal reveal-left active">
            ...
            <h1 className="text-7xl md:text-9xl font-black text-gray-900 dark:text-white mb-8 tracking-tighter leading-[0.85]">
              DEEPIKA <br /> <span className="font-serif italic font-normal text-primary">Makeup & Hair</span>
            </h1>
            <p className="text-xl md:text-2xl text-gray-600 dark:text-gray-300 leading-relaxed font-medium">
              Internationally certified makeup artist and trainer, bringing the best of both worlds in professional beauty services & training.
            </p>
          </div>
        </div>
      </section>
          ...
          <div className="flex flex-col lg:flex-row gap-24 items-center">
            <div className="w-full lg:w-1/2 reveal reveal-left">
              ...
              <div className="space-y-8 text-gray-600 dark:text-gray-400 text-lg md:text-xl leading-relaxed">
                <p>
                  Hi, I'm Deepika. For over a decade, I've been helping brides and students find their glow. My journey started with a simple passion for art and has grown into Bangalore's most trusted makeup academy.
                </p>
                <p>
                  I believe makeup isn't about covering up; it's about revealing who you truly are. Whether it's your wedding day or your first day learning the craft, I'm here to guide you with patience and expertise.
                </p>
                <p>
                  At my academy, we don't just teach techniques; we build careers. I'm proud to have trained over 1000 students who are now successful artists in their own right.
                </p>
              </div>
            </div>
            ...
            <div className="w-full lg:w-1/2 grid grid-cols-2 gap-6 reveal reveal-right">
              <div className="col-span-1 space-y-6 pt-12">
                ...
                <div className="aspect-square rounded-[2rem] bg-primary/5 flex flex-col justify-center p-8 border border-primary/10">
                  <span className="text-5xl font-black text-primary mb-2">10+</span>
                  <span className="text-xs font-bold uppercase tracking-widest text-gray-500">Years of Experience</span>
                </div>
              </div>
              <div className="col-span-1 space-y-6">
                <div className="aspect-square rounded-[2rem] bg-gray-50 dark:bg-surface p-8 border border-gray-200 dark:border-white/5 flex flex-col justify-center shadow-sm">
                  <span className="text-5xl font-black text-gray-900 dark:text-white mb-2">1000+</span>
                  <span className="text-xs font-bold uppercase tracking-widest text-gray-400">Students Trained</span>
                </div>
                <div className="aspect-[3/4] rounded-[2.5rem] overflow-hidden shadow-2xl transition-transform hover:rotate-2 border border-gray-100 dark:border-white/5">
          ...
          <div className="flex flex-col lg:flex-row gap-20 items-center">
            <div className="w-full lg:w-1/2 reveal reveal-left">
              ...
              <p className="text-xl text-gray-600 dark:text-gray-400 font-medium mb-12">
                We believe in compromising on nothing. Every product in Deepika's kit is curated from the finest brands to ensure a flawless finish.
              </p>
