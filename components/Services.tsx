    ...
    <section id="services" className="py-24 bg-white dark:bg-darkBg transition-colors duration-500 overflow-hidden">
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        <div className="reveal reveal-up text-center mb-20 max-w-3xl mx-auto">
          <h4 className="text-primary font-black uppercase tracking-[0.4em] text-sm mb-4">Our Expertise</h4>
          <h2 className="text-4xl md:text-7xl font-black text-gray-900 dark:text-white mb-6 tracking-tighter">CURATED ARTISTRY</h2>
          <p className="text-gray-600 dark:text-gray-400 text-lg md:text-xl leading-relaxed font-medium">
            From heritage temple weddings to high-fashion editorial campaigns, discover a world of bespoke beauty.
          </p>
        </div>
        ...
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-6 animate-fade-in">
          ...
          <div className="relative bg-white dark:bg-surface w-full max-w-2xl rounded-[3rem] overflow-hidden shadow-2xl animate-scale-in">
            ...
            <div className="p-10 sm:p-14">
              <span className="text-primary font-black uppercase tracking-[0.3em] text-xs block mb-4">Service Details</span>
              ...
              <div className="space-y-4 mb-10">
                <h4 className="text-gray-900 dark:text-white font-black uppercase text-sm tracking-widest">Key Features Included:</h4>
