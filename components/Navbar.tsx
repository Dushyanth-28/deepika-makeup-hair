    ...
    <nav className={`fixed top-0 left-0 right-0 z-50 transition-all duration-500 ${
      ...
      <div className="max-w-7xl mx-auto px-6 h-full flex items-center justify-between">
        ...
        >
          ...
          <span className={`text-xl font-black tracking-tighter uppercase italic ${
            isScrolled 
              ...
              : 'text-white' // Hero section usually has a dark overlay for contrast
          }`}>
            Urban Chic
          </span>
        </div>
        ...
        <div className="hidden md:flex items-center gap-8">
          {navItems.map((item) => (
            <button 
              ...
              className={`text-sm font-bold transition-all tracking-wide uppercase hover:text-primary ${
        ...
        <div className="flex items-center gap-4">
          ...
          <button 
            className={`${isScrolled ? 'text-gray-900 dark:text-white' : 'text-white'} md:hidden`}
